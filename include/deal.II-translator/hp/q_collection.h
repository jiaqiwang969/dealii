...
namespace hp
{
  /**
   * This class
   * implements a collection of quadrature objects in the same way   as the
  ...
  public:
     ...
     * more quadrature objects passed to the constructor. For this     call to
     * be valid, all arguments need to be of types derived     from class
     * Quadrature<dim>.
     *
     */
     ...
     * added to the   hp::FECollection   for which this quadrature rule
     * collection     is meant. If done this way, the   hp::FEValues   objects
     * with which you will     use both   hp::FECollection   and
     * hp::QCollection   objects will automatically     choose corresponding
     * elements and quadrature formulas. On the other hand,     it is possible
     * to use arbitrary combinations of elements and quadrature     formulas
     * in   hp::FECollection   and   hp::QCollection   objects when
     * specifically specifying appropriate indices in calls to
     * hp::FEValues::reinit()   or   hp::FEFaceValues::reinit().   In those
     * cases,     there need not be a correspondence between elements of the
     * hp::FECollection   and   hp::QCollection   objects; they need not even
     * be of     the same size in this case.         The same arguments about
     * the order of elements of collections can, by     the way, also be made
     * about the elements of   hp::MappingCollection       objects.
    ...
    /**
     * Equality comparison operator. All stored Quadrature objects are
     * compared     in order.
     *
     */
    bool
