 ...
 *
 *  The standard constructor of this class takes the degree   @p p   of this
 * finite element. For more information about the <tt>spacedim</tt> template
 * parameter check the documentation of FiniteElement or the one of
 ...
 * Bernstein   polynomials of degree   @p p.   This   @p
...
public:
   ...
   * thrown.     This function overrides the implementation from FE_Q_Base.
   *
   */
  virtual void
   ...
   * returns <tt>FE_Bernstein<dim>(degree)</tt>, with   @p dim   and   @p
