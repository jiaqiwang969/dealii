...
namespace Functions
{
   ...
   * wrapper for the FunctionParser class. It is used in the   step-34
   * tutorial   program.     It provides two methods to declare and parse a
   * ParameterHandler object   and creates the Function object declared in the
   * parameter file. This   class is derived from the AutoDerivativeFunction
   * class, so you don't need   to specify derivatives. An example of usage of
  ...
  public:
     ...
     * @p n_components   components (defaults to 1). The parameter   @p h   is
     * used     to initialize the AutoDerivativeFunction class from which this
     * class is     derived.
     *
     */
     ...
     * syntax for function declarations).         The three variables that can
     * be parsed from a parameter file are the     following:
     * @code
     *
     * set Function constants  =
     ...
     *
     * @endcode
     * for three dimensional problems.         The time variable can be set
     * according to specifications in the     FunctionTime base class.
     *
     */
    void
