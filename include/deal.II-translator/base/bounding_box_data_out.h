...
/**
 * This class generates graphical output for BoundingBox objects, starting
 * from any object that can be converted by boost to a BoundingBox.
 *
 *
 */
template <int dim>
...
public:
  ...
  /**
   * Generate patches from a range of objects that can be converted by boost
   * to   a collection of BoundingBox objects.     You could pass to this
   * function iterators to BoundingBox objects, or to   pairs or tuples in
   * which the first element is a BoundingBox object.
   *
   */
  ...
  /**
   * Generate patches from a container of objects that can be converted by
   * boost   to a collection of BoundingBox objects.     You could pass to
   * this function a container of BoundingBox objects, or a   container of
   ...
   * have the same size of the   @p dataset_names   argument.       @param[in]
   * datasets The actual data to attach to each patch     @param[in]
   * dataset_names The name of each component of the dataset
   *
   */
  void
