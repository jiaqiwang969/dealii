...
/**
 * The cubic polynomial space for the Adini element This space consists of the
 * cubic space <i>P<sub>3</sub></i> augmented by the functions
 * <i>xy<sup>3</sup></i> and <i>x<sup>3</sup>y</i>. The basis of the space is
 * chosen to match the node functionals of the Adini element.
 * @todo   This polynomial space is implemented in 2D only and does not
 * compute derivatives of order 3 or higher.
 *
 *
 * @ingroup Polynomials
 *
...
public:
   ...
   * <tt>unit_point</tt>.     Consider using evaluate() instead.
   *
   */
  Tensor<1, dim>
   ...
   * at <tt>unit_point</tt>.     Consider using evaluate() instead.
   *
   */
  Tensor<2, dim>
