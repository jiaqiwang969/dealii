...
namespace LinearAlgebra
{
  ...
  /**
   * A namespace for classes that provide wrappers for Trilinos' Epetra
   * vectors.     This namespace provides wrappers for the Epetra_FEVector
   * class from the   Epetra package (https://trilinos.github.io/epetra.html)
...
/**
 * Declare   dealii::LinearAlgebra::EpetraWrappers::Vector   as distributed
 * vector.
 *
 *
 */
