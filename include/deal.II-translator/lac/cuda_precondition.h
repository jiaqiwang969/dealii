...
namespace CUDAWrappers
{
   ...
   * preconditioner for   @em   symmetric   CUDAWrappers::SparseMatrix
   * matrices.     The implementation closely follows the one documented in
   * the cuSPARSE   documentation
  ...
  public:
     ...
     * stored. Specifically, this means     that the current object can only
     * be used reliably as long as   @p matrix   is valid     and has not been
     * changed since calling this function.         The   @p additional_data
  ...
  private:
    ...
    /**
     * Determine if level information should be generated for   $M=LL^T$  .
     * This     value can be modified through an AdditionalData object.
     *
     */
   ...
   * CUDAWrappers::SparseMatrix   matrices.     The implementation closely
   * follows the one documented in the cuSPARSE   documentation
  ...
  public:
    ...
    struct AdditionalData
    {
      /**
       * Constructor. cuSPARSE allows to compute and use level information.
       * to the documentation this might improve performance.       It is
       * suggested to try both options.
       *
       */
      AdditionalData(bool use_level_analysis = true);
