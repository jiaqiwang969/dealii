...
namespace MeshWorker
{
   ...
   * modified by applications to speed up the loop.     If a function is not
   * overloaded in a derived class, but its usage flag is   true, the function
   * will cause an exception ExcPureFunction.
   * @ingroup MeshWorker
   *
   */
