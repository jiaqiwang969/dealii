...
namespace internal
{
  namespace DoFHandlerImplementation
  {
    ...
    namespace Policy
    {
       ...
       * DoFHandler::distribute_dofs   and   DoFHandler::renumber_dofs
      ...
      public:
         ...
         * indices.                 Return an updated NumberCache for the
         * specified level of the         DoFHandler after renumbering.
         *
         */
        virtual NumberCache
        renumber_mg_dofs(
      ...
      public:
        /**
         * Constructor.           @param   dof_handler The DoFHandler object
         * upon which this           policy class is supposed to work.
         *
         */
      ...
      public:
         ...
         * argument.                 On distribution, DoFs are renumbered
         * subdomain-wise and
        ...
        /**
         * Renumber degrees of freedom as specified by the first argument.
         * The input argument   @p new_numbers   may either have as many
         * entries         as there are global degrees of freedom (i.e.
         * dof_handler.n_dofs() )         or
         * dof_handler.locally_owned_dofs().n_elements(). Therefore it can
