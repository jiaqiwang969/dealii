...
/**
 * Select data from AnyData corresponding to the attached name. Given a list
 * of names to search for (provided by add()), objects of this class provide
 * an index list of the selected data.
 *
 *
 */
...
public:
  /**
   * Add a new name to be searched for in   @p data   supplied in
   * initialize().
