...
namespace NonMatching
{
  ...
  public:
    ...
    /**
     * Extend the given formula by an additional quadrature point.     The
     * point, weight and normal should be with respect to reference space,
     * and the normal should be normalized.         This function exists since
     * immersed quadrature rules can be rather     complicated to construct.
     * Often the construction is done by     partitioning the cell into
     * regions and constructing points on each     region separately. This can
     * make it cumbersome to create the quadrature     from the constructor
     * since all quadrature points have to be known at     time of creation of
     * the object.
