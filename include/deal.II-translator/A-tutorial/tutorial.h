...
*  The programs are in the   <code>examples/</code>   directory of your local deal.II installation. After compiling the library itself, if you go into one of the tutorial directories, you can configure the program by typing   <code>cmake .</code>, build it via <code>make</code>   and run it using   <code>make run</code>  . The latter command also compiles the program if that has not already been done. The CMakeLists.txt files in the different directories are based on the <a href="../../users/cmake_user.html#cmakeauto" target="_top">autopilot
 style CMakeLists.txt example</a>.
* 

* 
*   @note   Some of the tutorial programs also jointly form   the <a href="../../doxygen/deal.II/group__geodynamics.html">geodynamics
   demonstration suite</a>. More, often more complex but less well documented,   deal.II-based programs than the ones that form the tutorial can also be   found in the   @ref CodeGallery   .
* 

*  <a name="graph"></a>   @anchor   TutorialConnectionGraph <h3>Connections between tutorial programs</h3>
...
digraph StepsMap
{
  ...
  Step7
* 
-> Step10 [color="orange",weight=5,];
  Step10
* 
-> Step11 [color="orange",weight=5,];
  Step7
* 
-> Step12 [color="orange",weight=5,];
  Step16
* 
-> Step12b [color="orange",weight=5,];
  Step7
* 
-> Step12b [color="orange",weight=5,];
  Step39
...
-> Step16 [];
  Step16
* 
-> Step16b [color="orange",weight=5,];
  Step8
* 
-> Step17 [];
  Step17
* 
-> Step18 [color="lightblue",weight=5,];
  Step6
* 
-> Step19 [];
  Step1
* 
-> Step2 [color="green",weight=100,];
  Step4
* 
-> Step20 [];
  Step20
* 
-> Step21 [color="yellow2",weight=5,];
  Step6
* 
-> Step22 [];
  Step21
* 
-> Step22 [color="yellow2",weight=5,];
  Step4
* 
-> Step23 [];
  Step23
* 
-> Step24 [color="dodgerblue1",weight=5,];
  Step24
* 
-> Step25 [color="dodgerblue1",weight=5,];
  Step6
* 
-> Step26 [];
  Step6
...
-> Step29 [];
  Step2
* 
-> Step3 [color="green",weight=100,];
  Step12
* 
-> Step30 [color="orange",weight=5,];
  Step22
* 
-> Step31 [color="yellow2",weight=5,];
  Step31
* 
-> Step32 [color="yellow2",weight=5,];
  Step55
* 
-> Step32 [color="yellow2",weight=5,];
  Step12
...
-> Step34 [];
  Step22
* 
-> Step35 [color="yellow2",weight=5,];
  Step4
* 
-> Step36 [];
  Step16
* 
-> Step37 [color="orange",weight=5,];
  Step40
* 
-> Step37 [];
  Step34
...
-> Step38 [];
  Step12b
* 
-> Step39 [color="orange",weight=5,];
  Step3
* 
-> Step4 [color="green",weight=100,];
  Step40a [style="invis"];  Step40b [style="invis"];  Step40c [style="invis"];  Step6
* 
...
-> Step41 [];
  Step41
* 
-> Step42 [color="lightblue",weight=5,];
  Step40
* 
-> Step42 [];
  Step31
* 
-> Step43 [color="yellow2",weight=5,];
  Step18
* 
-> Step44 [color="lightblue",weight=5,];
  Step6
* 
-> Step45 [];
  Step8
* 
-> Step46 [color="orange",weight=5,];
  Step22
* 
-> Step46 [];
  Step27
...
-> Step46 [color="orange",weight=5,];
  Step12
* 
-> Step47 [color="orange",weight=5,];
  Step25
* 
-> Step48 [color="dodgerblue1",weight=5,];
  Step37
* 
-> Step48 [];
  Step1
...
-> Step49 [];
  Step4
* 
-> Step5 [color="green",weight=100,];
  Step16
* 
-> Step50 [color="orange",weight=5,];
  Step37
* 
-> Step50 [color="orange",weight=5,];
  Step7
* 
-> Step51 [color="orange",weight=5,];
  Step9
* 
-> Step51 [color="orange",weight=5,];
  Step61
...
-> Step51 [color="orange",weight=5,];
  Step26
* 
-> Step52 [color="dodgerblue1",weight=5,];
  Step49
* 
-> Step53 [color="orange",weight=5,];
  Step53
* 
-> Step54 [color="orange",weight=5,];
  Step40
* 
-> Step55 [];
  Step22
* 
-> Step55 [color="yellow2",weight=5,];
  Step16
* 
-> Step56 [color="orange",weight=5,];
  Step22
* 
-> Step56 [];
  Step15
...
-> Step57 [];
  Step22
* 
-> Step57 [color="yellow2",weight=5,];
  Step26
* 
-> Step58 [color="dodgerblue1",weight=5,];
  Step29
* 
-> Step58 [];
  Step37
* 
-> Step59 [color="orange",weight=5,];
  Step5
* 
-> Step6 [color="green",weight=100,];
  Step6
* 
-> Step60 [];
  Step51
* 
-> Step61 [color="orange",weight=5,];
  Step8
* 
-> Step62 [color="orange",weight=5,];
  Step40
* 
-> Step62 [];
  Step16
* 
-> Step63 [color="orange",weight=5,];
  Step7
* 
-> Step64 [color="orange",weight=5,];
  Step37
* 
-> Step64 [color="orange",weight=5,];
  Step49
* 
-> Step65 [color="orange",weight=5,];
  Step15
* 
-> Step66 [color="orange",weight=5,];
  Step37
* 
-> Step66 [color="orange",weight=5,];
  Step33
* 
-> Step67 [color="yellow2",weight=5,];
  Step48
* 
-> Step67 [];
  Step59
...
-> Step67 [];
  Step19
* 
-> Step68 [color="orange",weight=5,];
  Step33
* 
-> Step69 [color="yellow2",weight=5,];
  Step40
* 
-> Step69 [];
  Step6
...
-> Step70 [];
  Step32
* 
-> Step70 [color="yellow2",weight=5,];
  Step60
* 
-> Step70 [];
  Step71
* 
-> Step72 [color="orange",weight=5,];
  Step15
* 
-> Step72 [color="orange",weight=5,];
  Step12
* 
-> Step74 [color="orange",weight=5,];
  Step27
* 
-> Step75 [color="orange",weight=5,];
  Step37
* 
-> Step75 [color="orange",weight=5,];
  Step40
...
-> Step75 [];
  Step67
* 
-> Step76 [color="yellow2",weight=5,];
  Step15
* 
-> Step77 [color="orange",weight=5,];
  Step26
* 
-> Step78 [];
  Step8
...
graph StepsDescription
{
  ...
  fluids
* 
-- fake_fluids [style=dotted, arrowhead=odot, arrowsize=1];
...
-- fake_unfinished [style=dotted, arrowhead=odot, arrowsize=1];
  ...
  time_dependent
* 
-- fake_time_dependent [style=dotted, arrowhead=odot, arrowsize=1];
  solids [label="" ,height=.25,width=.25, fillcolor="lightblue"];
  fake_solids [label="Solid mechanics", shape=plaintext];
  solids
* 
-- fake_solids [style=dotted, arrowhead=odot, arrowsize=1];
...
-- fake_techniques [style=dotted, arrowhead=odot, arrowsize=1];
  ...
  code_gallery
* 
-- fake_code_gallery [style=dotted, arrowhead=odot, arrowsize=1];
  basic [label="" ,height=.8,width=.8,shape="octagon", fillcolor="green"];
  fake_basic [label="Basic techniques", shape=plaintext];
  basic
* 
-- fake_basic [style=dotted, arrowhead=odot, arrowsize=1];
  basic
* 
-- techniques [style=invis];
  techniques
* 
-- fluids [style=invis];
  fluids
...
-- solids [style=invis];
  solids
* 
-- time_dependent [style=invis];
  time_dependent
* 
-- unfinished [style=invis];
  unfinished
* 
-- code_gallery [style=invis];
  {rank=same; basic, techniques, fluids, solids, time_dependent, unfinished, code_gallery}}
 @enddot
*  <a name="list"></a> <h3>Tutorial programs listed by number</h3>
...
*  <h4><b>Basic techniques</b><b>Basic techniques</b></h4>   <table align="center" width="90%">
* 
   <tr valign="top">
...
* 
 </table>   <h4><b>Advanced techniques</b><b>Advanced techniques</b></h4>   <table align="center" width="90%">
* 
   <tr valign="top">
...
* 
 </table>   <h4><b>Linear solvers</b><b>Linear solvers</b></h4>   <table align="center" width="90%">
* 
   <tr valign="top">
...
*  <h4><b>Other equations</b><b>Other equations</b></h4>   <table align="center" width="90%">
* 
   <tr valign="top">
...
* 
*  <h4><b>%Vector problems</b><b>%Vector problems</b></h4>   <table align="center" width="90%">
* 
   <tr valign="top">
...
* 
*  <h4><b>Time dependent problems</b><b>Time dependent problems</b></h4>   <table align="center" width="90%">
* 
   <tr valign="top">
