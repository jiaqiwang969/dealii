...
<ol>
  ...
  <li> <a href="#CommProg" class=bold>The commented program</a><a href="#CommProg" class=bold>The commented program</a>
    <ul>
      ...
      <ul>
        <li><a href="#Step5Step5">Step5::Step5</a><a href="#Step5Step5">Step5::Step5</a>
        <li><a href="#Step5setup_system">Step5::setup_system</a><a href="#Step5setup_system">Step5::setup_system</a>
        <li><a href="#Step5assemble_system">Step5::assemble_system</a><a href="#Step5assemble_system">Step5::assemble_system</a>
...
@f}
* The implementation in the   <code>assemble_system</code>   function followsimmediately from this.
* 
...
* 
 ...
 @endcode
* 
*   <a name="ThecodeStep5codeclasstemplate"></a>  <h3>The <code>Step5</code> class template</h3>
* 

* 
*  The main class is mostly as in the previous example. The most visible change is that the function   <code>make_grid</code>   has been removed, since creating the grid is now done in the   <code>run</code>   function and the rest of its functionality is now in   <code>setup_system</code>  . Apart from this, everything is as before.
* 
...
* 
 ...
 @endcode
* 
*   <a name="Workingwithnonconstantcoefficients"></a>  <h3>Working with nonconstant coefficients</h3>
* 
...
* 
 @endcode
* 
*   <a name="ThecodeStep5codeclassimplementation"></a>  <h3>The <code>Step5</code> class implementation</h3>
* 
...
* 
*  This is the function   <code>make_grid</code>   from the previous example, minus the generation of the grid. Everything else is unchanged:
* 
...
* 
 @endcode
* 
*  Next is the typical loop over all cells to compute local contributions and then to transfer them into the global matrix and vector. The only change in this part, compared to   step-4  , is that we will use the   <code>coefficient()</code>   function defined above to compute the coefficient value at each quadrature point.
* 
...
* 
*  With this, the rest of the function is trivial: instead of the   <code>PreconditionIdentity</code>   object we have created before, we now use the preconditioner we have declared, and the CG solver will do the rest for us:
* 
...
* 
 ...
 @endcode
* 
*   <a name="Step5output_resultsandsettingoutputflags"></a>  <h4>Step5::output_results and setting output flags</h4>
* 
...
* 
*  In previous examples, we have already used some of the functions from the   <code>GridGenerator</code>   class. Here we would like to read a grid from a file where the cells are stored and which may originate from someone else, or may be the product of a mesh generator tool.
* 
...
* 
*  So if we got past the assertion, we know that dim==2, and we can now actually read the grid. It is in UCD (unstructured cell data) format (though the convention is to use the suffix   <code>inp</code>   for UCD files):
* 
...
* @code
 ...
 @endcode
* 
*  If you like to use another input format, you have to use one of the other   <code>grid_in.read_xxx</code>   function. (See the documentation of the   <code>GridIn</code>   class to find out what input formats are presently supported.)
* 
