...
<ol>
  <li> <a href="#Intro" class=bold>Introduction</a><a href="#Intro" class=bold>Introduction</a>
    <ul>
        <li><a href="#AmotivationWhywouldIusethesetools">A motivation: Why would I use these tools?</a><a href="#AmotivationWhywouldIusethesetools">A motivation: Why would I use these tools?</a>
        <li><a href="#Theoryformagnetomechanicalmaterials">Theory for magneto-mechanical materials</a><a href="#Theoryformagnetomechanicalmaterials">Theory for magneto-mechanical materials</a>
      <ul>
        <li><a href="#Thermodynamicprinciples">Thermodynamic principles</a><a href="#Thermodynamicprinciples">Thermodynamic principles</a>
        <li><a href="#Constitutivelaws">Constitutive laws</a><a href="#Constitutivelaws">Constitutive laws</a>
      <ul>
        <li><a href="#Magnetoelasticconstitutivelaw">Magnetoelastic constitutive law</a><a href="#Magnetoelasticconstitutivelaw">Magnetoelastic constitutive law</a>
        <li><a href="#Magnetoviscoelasticconstitutivelaw">Magneto-viscoelastic constitutive law</a><a href="#Magnetoviscoelasticconstitutivelaw">Magneto-viscoelastic constitutive law</a>
      </ul>
      </ul>
        <li><a href="#Rheologicalexperiment">Rheological experiment</a><a href="#Rheologicalexperiment">Rheological experiment</a>
        <li><a href="#Suggestedliterature">Suggested literature</a><a href="#Suggestedliterature">Suggested literature</a>
    </ul>
  <li> <a href="#CommProg" class=bold>The commented program</a><a href="#CommProg" class=bold>The commented program</a>
    <ul>
        <li><a href="#AnintroductoryexampleThefundamentalsofautomaticandsymbolicdifferentiation">An introductory example: The fundamentals of automatic and symbolic differentiation</a><a href="#AnintroductoryexampleThefundamentalsofautomaticandsymbolicdifferentiation">An introductory example: The fundamentals of automatic and symbolic differentiation</a>
      <ul>
        <li><a href="#Ananalyticalfunction">An analytical function</a><a href="#Ananalyticalfunction">An analytical function</a>
        <li><a href="#Computingderivativesusingautomaticdifferentiation">Computing derivatives using automatic differentiation</a><a href="#Computingderivativesusingautomaticdifferentiation">Computing derivatives using automatic differentiation</a>
        <li><a href="#Handcalculatedderivativesoftheanalyticalsolution">Hand-calculated derivatives of the analytical solution</a><a href="#Handcalculatedderivativesoftheanalyticalsolution">Hand-calculated derivatives of the analytical solution</a>
        <li><a href="#Computingderivativesusingsymbolicdifferentiation">Computing derivatives using symbolic differentiation</a><a href="#Computingderivativesusingsymbolicdifferentiation">Computing derivatives using symbolic differentiation</a>
        <li><a href="#TheSimpleExamplerunfunction">The SimpleExample::run() function</a><a href="#TheSimpleExamplerunfunction">The SimpleExample::run() function</a>
      </ul>
        <li><a href="#AmorecomplexexampleUsingautomaticandsymbolicdifferentiationtocomputederivativesatcontinuumpoints">A more complex example: Using automatic and symbolic differentiation to compute derivatives at continuum points</a><a href="#AmorecomplexexampleUsingautomaticandsymbolicdifferentiationtocomputederivativesatcontinuumpoints">A more complex example: Using automatic and symbolic differentiation to compute derivatives at continuum points</a>
      <ul>
        <li><a href="#Constitutiveparameters">Constitutive parameters</a><a href="#Constitutiveparameters">Constitutive parameters</a>
        <li><a href="#ConstitutivelawsBaseclass">Constitutive laws: Base class</a><a href="#ConstitutivelawsBaseclass">Constitutive laws: Base class</a>
        <li><a href="#Magnetoelasticconstitutivelawusingautomaticdifferentiation">Magnetoelastic constitutive law (using automatic differentiation)</a><a href="#Magnetoelasticconstitutivelawusingautomaticdifferentiation">Magnetoelastic constitutive law (using automatic differentiation)</a>
        <li><a href="#Magnetoviscoelasticconstitutivelawusingsymbolicalgebraanddifferentiation">Magneto-viscoelastic constitutive law (using symbolic algebra and differentiation)</a><a href="#Magnetoviscoelasticconstitutivelawusingsymbolicalgebraanddifferentiation">Magneto-viscoelastic constitutive law (using symbolic algebra and differentiation)</a>
      </ul>
        <li><a href="#AmorecomplexexamplecontinuedParametersandhandderivedmaterialclasses">A more complex example (continued): Parameters and hand-derived material classes</a><a href="#AmorecomplexexamplecontinuedParametersandhandderivedmaterialclasses">A more complex example (continued): Parameters and hand-derived material classes</a>
      <ul>
        <li><a href="#Magnetoelasticconstitutivelawhandderived">Magnetoelastic constitutive law (hand-derived)</a><a href="#Magnetoelasticconstitutivelawhandderived">Magnetoelastic constitutive law (hand-derived)</a>
        <li><a href="#Magnetoviscoelasticconstitutivelawhandderived">Magneto-viscoelastic constitutive law (hand-derived)</a><a href="#Magnetoviscoelasticconstitutivelawhandderived">Magneto-viscoelastic constitutive law (hand-derived)</a>
        <li><a href="#Rheologicalexperimentparameters">Rheological experiment parameters</a><a href="#Rheologicalexperimentparameters">Rheological experiment parameters</a>
        <li><a href="#RheologicalexperimentParallelplaterotationalrheometer">Rheological experiment: Parallel plate rotational rheometer</a><a href="#RheologicalexperimentParallelplaterotationalrheometer">Rheological experiment: Parallel plate rotational rheometer</a>
        <li><a href="#TheCoupledConstitutiveLawsrunfunction">The CoupledConstitutiveLaws::run() function</a><a href="#TheCoupledConstitutiveLawsrunfunction">The CoupledConstitutiveLaws::run() function</a>
      </ul>
  ...
  <li value="3"> <a href="#Results" class=bold>Results</a><a href="#Results" class=bold>Results</a>
    <ul>
        <li><a href="#Introductoryexample">Introductory example</a><a href="#Introductoryexample">Introductory example</a>
        <li><a href="#Constitutivemodelling">Constitutive modelling</a><a href="#Constitutivemodelling">Constitutive modelling</a>
    </ul>
...
* Once we have the foundation upon which we can build further concepts, wewill see how AD in particular can be exploited at a finite element (rather thancontinuum) level: this is a topic that is covered in   step-72  , as well as   step-33  .But before then, let's take a moment to think about why we might want to considerusing these sorts of tools, and what benefits they can potentially offer you.
* 
...
* As a prelude to introducing the coupled magneto-mechanical material law that we'll useto model a magneto-active polymer, we'll start with a very concise summary ofthe salient thermodynamics to which these constitutive laws must subscribe.The basis for the theory, as summarized here, is described in copious detail byTruesdell and Toupin   @cite Truesdell1960a   and Coleman and Noll   @cite Coleman1963a  ,and follows the logic laid out by Holzapfel   @cite Holzapfel2007a  .
...
- \nabla_{0} \cdot \mathbf{Q}
  + R_{0} .
@f]The total internal energy includes contributions that arise not only due tomechanical deformation (the first term), and thermal fluxes and sources (thefourth and fifth terms), but also due to the intrinsic energy stored in themagnetic and electric fields themselves (the second and third terms,respectively).
...
- \dot{\psi}_{0} \left( \mathbf{C}, \mathbf{C}_{v}^{i}, \boldsymbol{\mathbb{H}} \right)
  \geq 0 .
@f](Notice the sign change on the second term on the right hand side, and thetransfer of the time derivative to the magnetic induction vector.)The stress quantity   $\mathbf{S}^{\text{tot}}$   is known as the total Piola-Kirchhoffstress tensor and its energy conjugate   $\mathbf{C} = \mathbf{F}^{T} \cdot \mathbf{F}$  is the right Cauchy-Green deformation tensor, and  $\mathbf{C}_{v}^{i} = \mathbf{C}_{v}^{i} \left( t \right)$   is the re-parameterizedinternal variable associated with the `i`th mechanical dissipative (viscous)mechanism.
...
@f](Again, note the use of the partial derivatives to define the stress and magneticinduction in this generalized setting.)From what terms remain in the dissipative power (namely those related to themechanical dissipative mechanisms), if they are assumed to be independent ofone another then, for each mechanism `i`,@f[
  ...
  \leq 0 .
@f]This constraint must be satisfied through the appropriate choice of free energyfunction, as well as a carefully considered evolution law for the internalvariables.
...
* 
- \mathbf{C}_{v} \right]
@f]for the internal viscous variable.We've chosen the magnetoelastic part of the energy  $\psi_{0}^{ME} \left( \mathbf{C}, \boldsymbol{\mathbb{H}} \right)$  to match that of the first material model that we explored, so this partneeds no further explanation. As for the viscous part   $\psi_{0}^{MVE}$  ,this component of the free energy (in conjunction with the evolution law forthe viscous deformation tensor) is taken from   @cite Linder2011a   (with theadditional scaling by the viscous saturation function described in  @cite Pelteret2018a  ). It is derived in a thermodynamically consistentframework that, at its core, models the movement of polymer chains on amicro-scale level.
...
= \frac{1}{1 + \frac{\Delta t}{\tau_{v}}} \left[
  ...
  + \frac{\Delta t}{\tau_{v}}
    ...
    \mathbf{C} \right]^{-1}
  \right]
@f]that matches   @cite Linder2011a   equation 54.
...
* The rheological experiment that we'll reproduce,which idealizes a laboratory experiment that was used to characterizemagneto-active polymers, is detailed in   @cite Pelteret2018a  (as well as   @cite Pelteret2019a  , in which it is documented along with thereal-world experiments). The images below provide a visual description ofthe problem set up.
...
* Under the assumptions that an incompressible medium is being tested,and that the deformation profile through the sample thickness is linear,then the displacement at some measurement point   $\mathbf{X}$   withinthe sample, expressed in radial coordinates, is
* @f{align*}
  r(\mathbf{X})
...
* In addition to the already mentioned   @ref auto_symb_diff   module, the following are a fewreferences that discuss in more detail
* 
...
* 
 @endcode
* 
*   <a name="AnintroductoryexampleThefundamentalsofautomaticandsymbolicdifferentiation"></a>  <h3>An introductory example: The fundamentals of automatic and symbolic differentiation</h3>
* 
...
*   Accompanying the description of the algorithmic steps to use the frameworks will be a simplified view as to what theymight* be doing in the background. This description will be very much one designed to aid understanding, and the reader is encouraged to view the   @ref auto_symb_diff   module documentation for a far more formal description into how these tools actually work.   
*  
...
* 
 ...
 @endcode
* 
*   <a name="Computingderivativesusingautomaticdifferentiation"></a>  <h4>Computing derivatives using automatic differentiation</h4>
* 
...
* 
 @endcode
* 
*  It is necessary that we pre-register with our   @p ADHelper   class how many arguments (what we will call "independent variables") the function   $f(x,y)$   has. Those arguments are `x` and `y`, so obviously there are two of them.
* 
...
* 
*   <a name="Handcalculatedderivativesoftheanalyticalsolution"></a>  <h4>Hand-calculated derivatives of the analytical solution</h4>
* 
...
*    $\frac{d^{2}f(x,y)}{dy dx} = \frac{1}{x^3} (x
 \sin\left(\frac{y}{x}\right) + y \cos\left(\frac{y}{x}\right))$   (as expected, on the basis of [Schwarz's theorem](https://en.wikipedia.org/wiki/Symmetry_of_second_derivatives))
* 
...
* 
*   <a name="Computingderivativesusingsymbolicdifferentiation"></a>  <h4>Computing derivatives using symbolic differentiation</h4>
* 
...
* 
 @endcode
* 
*  At this point it is legitimate to print out the expression `f_sd`, and if we did so   <div class=CodeFragmentInTutorialComment>
...
@code
 ...
 @endcode
* 
 </div>   we would see `f(x,y) = cos(y/x)` printed to the console.       
...
* @code
 ...
 @endcode
* 
*  Printing the expressions for the first and second derivatives, as computed by the CAS, using the statements   <div class=CodeFragmentInTutorialComment>
...
@code
 ...
 @endcode
* 
 </div>   renders the following output:   <div class=CodeFragmentInTutorialComment>
...
-cos(y/x)/x**2
 @endcode
* 
 </div>   This compares favorably to the analytical expressions for these derivatives that were presented earlier.
* 
...
* 
 ...
 @endcode
* 
*   <a name="TheSimpleExamplerunfunction"></a>  <h4>The SimpleExample::run() function</h4>
* 
...
* 
 ...
 @endcode
* 
*   <a name="AmorecomplexexampleUsingautomaticandsymbolicdifferentiationtocomputederivativesatcontinuumpoints"></a>  <h3>A more complex example: Using automatic and symbolic differentiation to compute derivatives at continuum points</h3>
* 
...
*   As you will recall from the introduction, the material constitutive laws we will consider are far more complicated than the simple example above. This is not just because of the form of the function   $\psi_{0}$   that we will consider, but in particular because   $\psi_{0}$   doesn't just depend on two scalar variables, but instead on a whole bunch oftensors*, each with several components. In some cases, these aresymmetric* tensors, for which only a subset of components is in fact independent, and one has to think about what it actually means to compute a derivative such as   $\frac{\partial\psi_{0}}{\partial \mathbf{C}}$   where   $\mathbf
 C$   is a symmetric tensor. How all of this will work will, hopefully, become clear below. It will also become clear that doing this by hand is going to be, at the very best,exceedingly*
...
*   The ConstitutiveParameters class is used to hold these values. Values for all parameters (both constitutive and rheological) are taken from   @cite Pelteret2018a  , and are given values that produce a constitutive response that is broadly representative of a real, laboratory-made magneto-active polymer, though the specific values used here are of no consequence to the purpose of this program of course.     
...
* 
 ...
 @endcode
* 
*   <a name="ConstitutivelawsBaseclass"></a>  <h4>Constitutive laws: Base class</h4>
* 
...
* 
 ...
 @endcode
* 
*   <a name="Magnetoelasticconstitutivelawusingautomaticdifferentiation"></a>  <h4>Magnetoelastic constitutive law (using automatic differentiation)</h4>
* 
...
* 
 @endcode
* 
*  Since we reuse the   @p ad_helper   data structure at each time step, we need to clear it of all stale information before use.
* 
...
* 
 @endcode
* 
*  The next step is to set the values for all field components. These define the "point" around which we'll be computing the function gradients and their linearization. The extractors that we created before provide the association between the fields and the registry within the   @p ad_helper  
* 
...
* 
 @endcode
* 
*  The stored energy density function is, in fact, the dependent variable for this problem, so as a final step in the  "configuration" phase, we register its definition with the   @p ad_helper.  
* 
...
* 
 ...
 @endcode
* 
*   <a name="Magnetoviscoelasticconstitutivelawusingsymbolicalgebraanddifferentiation"></a>  <h4>Magneto-viscoelastic constitutive law (using symbolic algebra and differentiation)</h4>
* 
...
- 1 \right]
 ...
 \mathbf{C} \right]^{-1}
 \right]
 @f] that was discretized using a first-order backward difference approximation.     
*   Again, let us see how this is implemented in a concrete class. Instead of the AD framework used in the previous class, we will now utilize the SD approach. To support this, the class constructor accepts not only the   @p constitutive_parameters,   but also two additional variables that will be used to initialize a   Differentiation::SD::BatchOptimizer.   We'll give more context to this later.
* 
...
*   These are the symbolic scalars that represent the elastic, viscous, and magnetic material parameters (defined mostly in the same order as they appear in the   @p ConstitutiveParameters   class). We also store a symbolic expression,   @p delta_t_sd,   that represents the time step size):
* 
...
*   Performing this code transformation is very computationally expensive, so we store the optimizer so that it is done just once per class instance. This also further motivates the decision to make the constitutive parameters themselves symbolic. We could then reuse a single instance of this   @p optimizer   across several materials (with the same energy function, of course) and potentially multiple continuum points (if embedded within a finite element simulation).       
...
* 
 @endcode
* 
*  Due to the "natural" use of the symbolic expressions, much of the procedure to configure the   @p optimizer   looks very similar to that which is used to construct the automatic differentiation helper. Nevertheless, we'll detail these steps again to highlight the differences that underlie the two frameworks.     
...
* 
 @endcode
* 
*  In addition, we define the magneto-viscoelastic contribution to the free energy density function. The first component required to implement this is a scaling function that will cause the viscous shear modulus to change (increase) under the influence of a magnetic field (see   @cite Pelteret2018a  , equation 29). Thereafter we can compute the dissipative component of the energy density function; its expression is stated in   @cite Pelteret2018a   (equation 28), which is a straight-forward extension of an energy density function formulated in   @cite Linder2011a   (equation 46).
* 
...
* 
 @endcode
* 
*  As it stands, to the CAS the variable   @p Q_t_sd   appears to be independent of   @p C_sd.   Our tensorial symbolic expression   @p Q_t_sd   just has an identifier associated with it, and there is nothing that links it to the other tensorial symbolic expression   @p C_sd.   So any derivatives taken with respect to   @p C_sd   will ignore this inherent dependence which, as we can see from the evolution law, is in fact   $\mathbf{C}_{v} = \mathbf{C}_{v} \left( \mathbf{C}, t \right)$  . This means that deriving any function   $f = f(\mathbf{C}, \mathbf{Q})$   with respect to    $\mathbf{C}$   will return partial derivatives   $\frac{\partial f(\mathbf{C}, \mathbf{Q})}{\partial \mathbf{C}}
...
*   It is this specific level of control that characterizes a defining difference difference between the SD and AD frameworks. In a few lines we'll be manipulating the expression for the internal variable   @p Q_t_sd   such that it produces the correct linearization.
* 
...
* 
 @endcode
* 
*  Since the next step is to linearize the above, it is the appropriate time to inform the CAS of the explicit dependency of   @p Q_t_sd   on   @p C_sd,   i.e., state that   $\mathbf{C}_{v} = \mathbf{C}_{v} \left( \mathbf{C}, t
 \right)$  . This means that all future differential operations made with respect to   @p C_sd   will take into account this dependence (i.e., compute total derivatives). In other words, we will transform some expression such that their intrinsic parameterization changes from   $f(\mathbf{C}, \mathbf{Q})$   to   $f(\mathbf{C}, \mathbf{Q}(\mathbf{C}))$  .       
...
* 
 @endcode
* 
*  Next we produce an intermediate substitution map, which will take every instance of   @p Q_t_sd   (our identifier) found in an expression and replace it with the full expression held in   @p Q_t_sd_explicit.  
* 
...
* 
 @endcode
* 
*  Now we need to tell the   @p optimizer   what entries we need to provide numerical values for in order for it to successfully perform its calculations. These essentially act as the input arguments to all dependent functions that the   @p optimizer   must evaluate. They are, collectively, the independent variables for the problem, the history variables, the time step sie and the constitutive parameters (since we've not hard encoded them in the energy density function).       
*   So what we really want is to provide it a collection of symbols, which one could accomplish in this way:   <div class=CodeFragmentInTutorialComment>
...
* 
 @endcode
* 
*  Since the configuration of the   @p optimizer   was done up front, there's very little to do each time we want to compute kinetic variables or their linearization (derivatives).
* 
...
* 
 ...
 @endcode
* 
*   <a name="AmorecomplexexamplecontinuedParametersandhandderivedmaterialclasses"></a>  <h3>A more complex example (continued): Parameters and hand-derived material classes</h3>
* 
...
* 
*   <a name="Magnetoelasticconstitutivelawhandderived"></a>  <h4>Magnetoelastic constitutive law (hand-derived)</h4>
* 
...
* 
 @endcode
* 
*  The second derivative of saturation function, noting that   $\frac{d \text{sech}^{2}(x)}{dx} =
* 
...
* 
 ...
 @endcode
* 
*   <a name="Magnetoviscoelasticconstitutivelawhandderived"></a>  <h4>Magneto-viscoelastic constitutive law (hand-derived)</h4>
* 
...
-
 ...
 \mathbf{C} \right]^{-1}
 \right]
 @f] will also dictate how the linearization of the internal variable with respect to the field variables is composed.     
*   Observe that in order to attain thecorrect* expressions for the magnetic induction vector and total Piola-Kirchhoff stress tensor for this dissipative material, we must adhere strictly to the outcome of applying the Coleman-Noll procedure: we must takepartial derivatives*
 ...
 \right)$   with respect to   $\mathbf{C}$  
* 
...
*  with @f[
 ...
 \mathbf{C}^{-1}}{d \mathbf{C}}
 \right] .
 @f] Notice that just the last term of   $\mathcal{H}^{\text{tot}, MVE}$   contains the tangent of the internal variable. The linearization of this particular evolution law is linear. For an example of a nonlinear evolution law, for which this linearization must be solved for in an iterative manner, see   @cite Koprowski  -Theiss2011a.
* 
...
* 
 @endcode
* 
*   <a name="Rheologicalexperimentparameters"></a>  <h4>Rheological experiment parameters</h4>
* 

* 
*  The   @p RheologicalExperimentParameters   class is used to drive the numerical experiments that are to be conducted on the coupled materials that we've implemented constitutive laws for.
* 
...
* 
 @endcode
* 
*   <a name="RheologicalexperimentParallelplaterotationalrheometer"></a>  <h4>Rheological experiment: Parallel plate rotational rheometer</h4>
* 
...
* 
 @endcode
* 
*   <a name="TheCoupledConstitutiveLawsrunfunction"></a>  <h4>The CoupledConstitutiveLaws::run() function</h4>
* 
...
* With less effort, one could think about re-writing nonlinear problemsolvers such as the one implemented in   step-15   using AD or SDapproaches to compute the Newton matrix. Indeed, this is done in  step-72  .
* 
