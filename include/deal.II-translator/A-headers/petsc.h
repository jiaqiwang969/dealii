...
/**
 *
 * @defgroup PETScWrappers PETScWrappers The classes in this module are
 ...
 * this group reside in a namespace   @p PETScWrappers. These classes are only
 * available if a PETSc installation was detected during configuration of
