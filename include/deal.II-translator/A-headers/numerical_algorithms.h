...
/**
 *
 * @defgroup numerics Numerical algorithms This module groups a diverse set of
 * classes that generally implement some sort of numerical algorithm on top
 * all the basic triangulation, DoFHandler, and finite element classes in the
 * library. They are generally unconnected to each other. Some of the classes,
 * like DerivativeApproximation, KellyErrorEstimator and SolutionTransfer, act
 * on solutions already obtained, and compute derived quantities in the first
 * two cases, or help transferring a set of vectors from one mesh to another.
