...
#ifdef DEAL_II_WITH_TBB
/**
 * For backwards compatibility, continue defining DEAL_II_WITH_THREADS when
 * the library is configured with TBB.
 */
#define DEAL_II_WITH_THREADS
 ...
 * Various macros for version number query and comparison:
 *
 * These macros are defined to make testing for specific versions within the
 * deal.II main code as simple as possible.
 */
...
/**
 * ******************************************************************** Two
 * macro names that we put at the top and bottom of all deal.II files and that
 * will be expanded to "namespace dealii {" and "}".
 */
...
/**
 * ******************************************************************** Two
 * macros to guard external header includes.
 *
 * Selectively disable diagnostics set by "-Wextra" (and similar flags) for
 * GCC and compiler accepting GCC dialects (such as clang). "diagnostic push"
 * is supported since gcc-4.6 and clang-3.3.
 */
...
/**
 * ******************************************************************** Define
 * macros for picking the correct C linkage name for a Fortran function. See
 * cmake/configure/configure_fortran_mangling.cmake for more information.
 */
...
/**
 * ******************************************************************** Define
 * a portable preprocessor macro that generates custom warnings reporting the
 * line and the file where the warning appears. Taken from:
 * http://goodliffe.blogspot.com/2009/07/c-how-to-say-warning-to-visual-studio-c.html
 */
