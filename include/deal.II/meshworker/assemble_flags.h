...
namespace MeshWorker
{
   ...
   * which elements need to be assembled.     You can select more than one
   * flag by concatenation using the bitwise or
   ...
   * assign it to an object of type AssembleFlags.       @ref AssembleFlags
   *
   */
   ...
   * set in the second argument.       @ref AssembleFlags
   *
   */
  inline AssembleFlags &
  operator&=(AssembleFlags &f1, AssembleFlags f2)
