 ...
 * aliased to generic names. There are similar namespaces LinearAlgebraDealII
 * and LinearAlgebraTrilinos for alias to deal.II's own classes and classes
 * that interface with Trilinos.
 *
 *
 */
