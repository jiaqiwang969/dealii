...
protected:
  ...
  public:
     ...
     * line but on vertices are not included.         This function chooses
     * the respective points not such that they are     interpolating the
     * boundary (as does the base class), but rather such     that the
     * resulting cubic mapping is a continuous one.
     *
     */
    virtual void
     ...
     * located on the line but on vertices are not included.         This
     * function chooses the respective points not such that they are
