...
public:
   ...
   * if the source element is also a   @p FE_Q     element. Otherwise, an
   * exception of type
   ...
   * of the associated operator.     If projection matrices are not
   * implemented in the derived finite element   class, this function aborts
   * with ExcProjectionVoid. You can check whether   this is the case by
   * calling the restriction_is_implemented() or the
   ...
   * are discarded and will not fill up the transfer matrix.     If projection
   * matrices are not implemented in the derived finite element   class, this
   * function aborts with ExcEmbeddingVoid. You can check whether   this is
   * the case by calling the prolongation_is_implemented() or the
...
protected:
  ...
  /**
   * Initialize the   @p adjust_quad_dof_index_for_face_orientation_table
   ...
   * implementation.     See the .cc file for more information.
   *
   */
