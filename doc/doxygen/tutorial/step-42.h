...
<ol>
  <li> <a href="#Intro" class=bold>Introduction</a><a href="#Intro" class=bold>Introduction</a>
    <ul>
        ...
        <li><a href="#Reformulationasavariationalinequality">Reformulation as a variational inequality</a><a href="#Reformulationasavariationalinequality">Reformulation as a variational inequality</a>
        <li><a href="#ANewtonmethodfortheplasticnonlinearity">A Newton method for the plastic nonlinearity</a><a href="#ANewtonmethodfortheplasticnonlinearity">A Newton method for the plastic nonlinearity</a>
        ...
        <li><a href="#Overallalgorithm">Overall algorithm</a><a href="#Overallalgorithm">Overall algorithm</a>
  ...
  <li> <a href="#CommProg" class=bold>The commented program</a><a href="#CommProg" class=bold>The commented program</a>
    <ul>
        ...
        <li><a href="#ThecodeConstitutiveLawcodeclasstemplate">The <code>ConstitutiveLaw</code> class template</a><a href="#ThecodeConstitutiveLawcodeclasstemplate">The <code>ConstitutiveLaw</code> class template</a>
      <ul>
        <li><a href="#ConstitutiveLawget_stress_strain_tensor">ConstitutiveLaw::get_stress_strain_tensor</a><a href="#ConstitutiveLawget_stress_strain_tensor">ConstitutiveLaw::get_stress_strain_tensor</a>
        <li><a href="#ConstitutiveLawget_linearized_stress_strain_tensors">ConstitutiveLaw::get_linearized_stress_strain_tensors</a><a href="#ConstitutiveLawget_linearized_stress_strain_tensors">ConstitutiveLaw::get_linearized_stress_strain_tensors</a>
        <li><a href="#ThecodeSphereObstaclecodeclass">The <code>SphereObstacle</code> class</a><a href="#ThecodeSphereObstaclecodeclass">The <code>SphereObstacle</code> class</a>
        <li><a href="#ThecodeBitmapFilecodeandcodeChineseObstaclecodeclasses">The <code>BitmapFile</code> and <code>ChineseObstacle</code> classes</a><a href="#ThecodeBitmapFilecodeandcodeChineseObstaclecodeclasses">The <code>BitmapFile</code> and <code>ChineseObstacle</code> classes</a>
      </ul>
        <li><a href="#ThecodePlasticityContactProblemcodeclasstemplate">The <code>PlasticityContactProblem</code> class template</a><a href="#ThecodePlasticityContactProblemcodeclasstemplate">The <code>PlasticityContactProblem</code> class template</a>
        <li><a href="#ImplementationofthecodePlasticityContactProblemcodeclass">Implementation of the <code>PlasticityContactProblem</code> class</a><a href="#ImplementationofthecodePlasticityContactProblemcodeclass">Implementation of the <code>PlasticityContactProblem</code> class</a>
      <ul>
        <li><a href="#PlasticityContactProblemdeclare_parameters">PlasticityContactProblem::declare_parameters</a><a href="#PlasticityContactProblemdeclare_parameters">PlasticityContactProblem::declare_parameters</a>
        <li><a href="#ThecodePlasticityContactProblemcodeconstructor">The <code>PlasticityContactProblem</code> constructor</a><a href="#ThecodePlasticityContactProblemcodeconstructor">The <code>PlasticityContactProblem</code> constructor</a>
        <li><a href="#PlasticityContactProblemmake_grid">PlasticityContactProblem::make_grid</a><a href="#PlasticityContactProblemmake_grid">PlasticityContactProblem::make_grid</a>
        <li><a href="#PlasticityContactProblemsetup_system">PlasticityContactProblem::setup_system</a><a href="#PlasticityContactProblemsetup_system">PlasticityContactProblem::setup_system</a>
        <li><a href="#PlasticityContactProblemcompute_dirichlet_constraints">PlasticityContactProblem::compute_dirichlet_constraints</a><a href="#PlasticityContactProblemcompute_dirichlet_constraints">PlasticityContactProblem::compute_dirichlet_constraints</a>
        <li><a href="#PlasticityContactProblemassemble_mass_matrix_diagonal">PlasticityContactProblem::assemble_mass_matrix_diagonal</a><a href="#PlasticityContactProblemassemble_mass_matrix_diagonal">PlasticityContactProblem::assemble_mass_matrix_diagonal</a>
        <li><a href="#PlasticityContactProblemupdate_solution_and_constraints">PlasticityContactProblem::update_solution_and_constraints</a><a href="#PlasticityContactProblemupdate_solution_and_constraints">PlasticityContactProblem::update_solution_and_constraints</a>
        <li><a href="#PlasticityContactProblemassemble_newton_system">PlasticityContactProblem::assemble_newton_system</a><a href="#PlasticityContactProblemassemble_newton_system">PlasticityContactProblem::assemble_newton_system</a>
        <li><a href="#PlasticityContactProblemcompute_nonlinear_residual">PlasticityContactProblem::compute_nonlinear_residual</a><a href="#PlasticityContactProblemcompute_nonlinear_residual">PlasticityContactProblem::compute_nonlinear_residual</a>
        <li><a href="#PlasticityContactProblemsolve_newton_system">PlasticityContactProblem::solve_newton_system</a><a href="#PlasticityContactProblemsolve_newton_system">PlasticityContactProblem::solve_newton_system</a>
        <li><a href="#PlasticityContactProblemsolve_newton">PlasticityContactProblem::solve_newton</a><a href="#PlasticityContactProblemsolve_newton">PlasticityContactProblem::solve_newton</a>
        <li><a href="#PlasticityContactProblemrefine_grid">PlasticityContactProblem::refine_grid</a><a href="#PlasticityContactProblemrefine_grid">PlasticityContactProblem::refine_grid</a>
        <li><a href="#PlasticityContactProblemmove_mesh">PlasticityContactProblem::move_mesh</a><a href="#PlasticityContactProblemmove_mesh">PlasticityContactProblem::move_mesh</a>
        <li><a href="#PlasticityContactProblemoutput_results">PlasticityContactProblem::output_results</a><a href="#PlasticityContactProblemoutput_results">PlasticityContactProblem::output_results</a>
        <li><a href="#PlasticityContactProblemoutput_contact_force">PlasticityContactProblem::output_contact_force</a><a href="#PlasticityContactProblemoutput_contact_force">PlasticityContactProblem::output_contact_force</a>
        <li><a href="#PlasticityContactProblemrun">PlasticityContactProblem::run</a><a href="#PlasticityContactProblemrun">PlasticityContactProblem::run</a>
      </ul>
...
* This problem description implies that we have to take care of an additionalnonlinearity compared to   step-41  : thematerial behavior. Since we consider a three dimensional problem here, we alsohave to account for the fact that the contact area is at the boundary ofthe deformable body now, rather than in the interior. Finally, compared to  step-41  , we also have to deal with hanging nodes in both the handling of the linearsystem as well as of the inequality constraints as we would like to use anadaptive mesh; in the latter case, we willhave to deal with prioritizing whether the constraints from the hanging nodesor from the inequalities are more important.
* Since you can very easily reach a few million degrees of freedom in threedimensions, even with adaptive mesh refinement, we decided to use Trilinos andp4est to run our code in parallel, building on the framework of   step-40   forthe parallelization. Additional pointers for parallelization can be found in  step-32  .
* 
...
@f}
* Here, the first of these equations defines therelationship between strain   $\varepsilon(\mathbf u)=\frac{1}{2}\left(\nabla \mathbf u
...
\mathcal{F}(\sigma)/\partial \sigma$  . The inequality   $\mathcal{F}(\sigma)\le 0$   isa statement of the fact that plastic materials can only support a finite amountof stress; in other words, they react with plastic deformations   $\varepsilon^p$  if external forces would result in a stress   $\sigma$   for which   $\mathcal{F}(\sigma)> 0$  would result. A typical form for this <i>yield function</i> is  $\mathcal{F}(\sigma)=|\sigma^D|-\sigma_{\text{yield}}$   where   $\tau^D
= \tau
* 
- \dfrac{1}{3}tr(\tau)I$   is the deviatoric part of a tensorand   $|\cdot|$   denotes the Frobenius norm.
* Further equations describe afixed, zero displacement on   $\Gamma_D$   andthat on the surface   $\Gamma_C=\partial\Omega\backslash\Gamma_D$   where contact may appear, the normalforce   $\sigma_n=\mathbf n \cdot (\sigma(\mathbf u)
  \mathbf n)$   exerted by the obstacle is inward (no "pull" by the obstacle on ourbody) and with zero tangential component   $\mathbf \sigma_t= \sigma \mathbf n
* 
- \mathbf \sigma_n \mathbf n
= \sigma \mathbf n
* 
- [\mathbf n \cdot(\sigma \mathbf n)]\mathbf n$  .The last condition is again a complementarity condition thatimplies that on   $\Gamma_C$  , the normalforce can only be nonzero if the body is in contact with the obstacle; thesecond part describes the impenetrability of the obstacle and the body.The last two equations are commonly referred to as the Signorini contactconditions.
* Most materials
* 
*  - especially metals
* 
...
* It is generally rather awkward to deal with inequalities. Here, we have to deal withtwo: plasticity and the contact problem.As described in more detail in the paper mentioned at the top of this page, onecan at least reformulate the plasticity in a way that makes it look like anonlinearity that we can then treat with Newton's method. This is slightlytricky mathematically since the nonlinearity is not just some smoothfunction but instead has kinks where the stress reaches the yield stress;however, it can be shown for such <i>semismooth</i> functions that Newton'smethod still converges.
* Without going into details, we will also get rid of the stress as an independentvariable and instead work exclusively with the displacements   $\mathbf u$  . Ultimately,the goal of this reformulation is that we will want to end up with a symmetric,positive definite problem
* 
...
* @f{align*}
 P_{\Pi}(\tau) \dealcoloneq \begin{cases}
  ...
  \end{cases}
@f}
* and the space   $V^+$   is the space of all displacements that satisfy the contactcondition:
* @f{align*}
  V
  &=
...
* As mentioned, we will treat the nonlinearity of the operator   $P_\Pi$   byapplying a Newton method, despite the fact that the operator is not differentiablein the strict sense. However, it satisfies the conditions of <i>slant</i>differentiability and this turns out to be enough for Newton's method to work.The resulting method then goes by the name <i>semi-smooth Newton method</i>,which sounds impressive but is, in reality, just a Newton method applied toa semi-smooth function with an appropriately chosen "derivative".
...
* As a final note about the Newton method let us mention that as is common withNewton methods we need to globalize it by controlling the step length. Inother words, while the system above solves for   $\tilde {\mathbf u}^{i}$  , the finaliterate will rather be
* @f{align*}
  {\mathbf u}^{i} = {\mathbf u}^{i-1} + \alpha_i (\tilde {\mathbf u}^{i}
* 
- {\mathbf u}^{i-1})
@f}
* where the difference in parentheses on the right takes the role of thetraditional Newton direction,   $\delta {\mathbf u}^{i}$  . We will determine  $\alpha^i$   using a standard line search.
* 

* <a name="ActiveSetmethodstosolvethesaddlepointproblem"></a><h3>Active Set methods to solve the saddle point problem</h3>
* 

* This linearized problem to be solved in each Newton step is essentially likein   step-41  . The only difference consists in the fact that the contact areais at the boundary instead of in the domain. But this has no further consequenceso that we refer to the documentation of   step-41   with the only hint that  $\mathcal{S}$   contains all the vertices at the contact boundary   $\Gamma_C$   thistime. As there, what we need to do is keep a subset of degrees of freedom fixed,leading to additional constraints that one can write as a saddle point problem.However, as discussed in the paper, by writing these constraints in anappropriate way that removes the coupling between degrees of freedom,we end up with a set of nodes that essentially just have Dirichlet valuesattached to them.
* 
...
* 
*    <li>   Damp the Newton iteration for   $i>2$   by applying a line search and calculating a linear combination of   $U^{i-1}$   and   $\tilde U^i$  . This requires finding an   $\alpha^i_l \dealcoloneq 2^{-l},(l=0,\ldots,10)$   so that @f{gather*}U^i \dealcoloneq \alpha^i_l\bar U^i +
 (1-\alpha^i_l)U^{i-1}@f}
*  satisfies @f{gather*}
...
* 
*    <li>  Project   $U^i$   so that it satisfies the contact inequality, @f{gather*}\hat U^i \dealcoloneq P_{\mathcal{A}_{i+1}}(U^i).@f}
*  Here,   $P_{\mathcal{A}}(U)$   is the projection of the active components in   $\mathcal{A}$   to the gap @f{gather*}P_{\mathcal{A}}(U)_p \dealcoloneq \begin{cases}
 ...
 p\in\mathcal{A},
 \end{cases}@f}
*  where   $g_{h,p}$   is the <i>gap</i> denoting the distance of the obstacle from the undisplaced configuration of the body.
...
* Since we run our program in 3d, the computations the program performs areexpensive. Consequently using adaptive mesh refinement is an important step towardsstaying within acceptable run-times. To make our lives easier we simply choose theKellyErrorEstimator that is already implemented in deal.II. We hand thesolution vector to it which contains the displacement   $u$  . As we will see in theresults it yields a quite reasonable adaptive mesh for the contact zone as wellas for plasticity.
* 

* <a name="Implementation"></a><h3>Implementation</h3>
* 

* This tutorial is essentially a mixture of   step-40   and   step-41   but instead ofPETSc we let the Trilinos library deal with parallelizing the linear algebra(like in   step-32  ). Since we are trying to solve a similar problem like in  step-41   we will use the same methods but now in parallel.
...
*   <a name="Includefiles"></a>  <h3>Include files</h3> The set of include files is not much of a surprise any more at this time:
* 
...
* 
 @endcode
* 
*  Finally, we include two system headers that let us create a directory for output files. The first header provides the   <code>mkdir</code>   function and the second lets us determine what happened if   <code>mkdir</code>   fails.
* 
...
* 
 @endcode
* 
*   <a name="ThecodeConstitutiveLawcodeclasstemplate"></a>  <h3>The <code>ConstitutiveLaw</code> class template</h3>
* 
...
*   As explained in the paper that describes this program, the first Newton steps are solved with a completely elastic material model to avoid having to deal with both nonlinearities (plasticity and contact) at once. To this end, this class has a function   <code>set_sigma_0()</code>   that we use later on to simply set   $\sigma_0$   to a very large value
* 
...
* 
 ...
 @endcode
* 
*   <a name="ConstitutiveLawget_stress_strain_tensor"></a>  <h4>ConstitutiveLaw::get_stress_strain_tensor</h4>
* 
...
* 
 ...
 @endcode
* 
*   <a name="ConstitutiveLawget_linearized_stress_strain_tensors"></a>  <h4>ConstitutiveLaw::get_linearized_stress_strain_tensors</h4>
* 

* 
*  This function returns the linearized stress strain tensor, linearized around the solution   $u^{i-1}$   of the previous Newton step   $i-1$  .  The parameter   <code>strain_tensor</code>   (commonly denoted   $\varepsilon(u^{i-1})$  ) must be passed as an argument, and serves as the linearization point. The function returns the derivative of the nonlinear constitutive law in the variable stress_strain_tensor, as well as the stress-strain tensor of the linearized problem in stress_strain_tensor_linearized.  See   PlasticityContactProblem::assemble_nl_system   where this function is used.
* 
...
* 
 @endcode
* 
*   <a name="ThecodeSphereObstaclecodeclass"></a>  <h4>The <code>SphereObstacle</code> class</h4>
* 
...
* 
 @endcode
* 
*   <a name="ThecodeBitmapFilecodeandcodeChineseObstaclecodeclasses"></a>  <h4>The <code>BitmapFile</code> and <code>ChineseObstacle</code> classes</h4>
* 
...
*   The   <code>hx,hy</code>   variables denote the spacing between pixels in   $x$   and   $y$   directions.   <code>nx,ny</code>   are the numbers of pixels in each of these directions.    <code>get_value()</code>   returns the value of the image at a given location, interpolated from the adjacent pixel values.
* 
...
* 
 @endcode
* 
*   <a name="ThecodePlasticityContactProblemcodeclasstemplate"></a>  <h3>The <code>PlasticityContactProblem</code> class template</h3>
* 
...
* 
 @endcode
* 
*  The next group describes the mesh and the finite element space. In particular, for this parallel program, the finite element space has associated with it variables that indicate which degrees of freedom live on the current processor (the index sets, see also   step-40   and the   @ref distributed   documentation module) as well as a variety of constraints: those imposed by hanging nodes, by Dirichlet boundary conditions, and by the active set of contact nodes. Of the three AffineConstraints variables defined here, the first only contains hanging node constraints, the second also those associated with Dirichlet boundary conditions, and the third these plus the contact constraints.     
*   The variable   <code>active_set</code>   consists of those degrees of freedom constrained by the contact, and we use   <code>fraction_of_plastic_q_points_per_cell</code>   to keep track of the fraction of quadrature points on each cell where the stress equals the yield stress. The latter is only used to create graphical output showing the plastic zone, but not for any further computation; the variable is a member variable of this class since the information is computed as a by-product of computing the residual, but is used only much later. (Note that the vector is a vector of length equal to the number of active cells on the <i>local mesh</i>; it is never used to exchange information between processors and can therefore be a regular deal.II vector.)
* 
...
* 
 @endcode
* 
*  And then there is an assortment of other variables that are used to identify the mesh we are asked to build as selected by the parameter file, the obstacle that is being pushed into the deformable body, the mesh refinement strategy, whether to transfer the solution from one mesh to the next, and how many mesh refinement cycles to perform. As possible, we mark these kinds of variables as   <code>const</code>   to help the reader identify which ones may or may not be modified later on (the output directory being an exception
* 
...
* 
 ...
 @endcode
* 
*   <a name="ImplementationofthecodePlasticityContactProblemcodeclass"></a>  <h3>Implementation of the <code>PlasticityContactProblem</code> class</h3>
* 

* 
*   <a name="PlasticityContactProblemdeclare_parameters"></a>  <h4>PlasticityContactProblem::declare_parameters</h4>
* 
...
* 
 ...
 @endcode
* 
*   <a name="ThecodePlasticityContactProblemcodeconstructor"></a>  <h4>The <code>PlasticityContactProblem</code> constructor</h4>
* 
...
* 
 @endcode
* 
*   <a name="PlasticityContactProblemmake_grid"></a>  <h4>PlasticityContactProblem::make_grid</h4>
* 
...
* 
 ...
 @endcode
* 
*  Alternatively, create a hypercube mesh. After creating it, assign boundary indicators as follows:   <div class=CodeFragmentInTutorialComment>
...
* 
 @endcode
* 
*   <a name="PlasticityContactProblemsetup_system"></a>  <h4>PlasticityContactProblem::setup_system</h4>
* 
...
* 
 ...
 @endcode
* 
*   <a name="PlasticityContactProblemcompute_dirichlet_constraints"></a>  <h4>PlasticityContactProblem::compute_dirichlet_constraints</h4>
* 

* 
*  This function, broken out of the preceding one, computes the constraints associated with Dirichlet-type boundary conditions and puts them into the   <code>constraints_dirichlet_and_hanging_nodes</code>   variable by merging with the constraints that come from hanging nodes.   
...
* 
 ...
 @endcode
* 
*   <a name="PlasticityContactProblemupdate_solution_and_constraints"></a>  <h4>PlasticityContactProblem::update_solution_and_constraints</h4>
* 

* 
*  The following function is the first function we call in each Newton iteration in the   <code>solve_newton()</code>   function. What it does is to project the solution onto the feasible set and update the active set for the degrees of freedom that touch or penetrate the obstacle.   
...
* 
 @endcode
* 
*  At the end of this function, we exchange data between processors updating those ghost elements in the   <code>solution</code>   variable that have been written by other processors. We then merge the Dirichlet constraints and those from hanging nodes into the AffineConstraints object that already contains the active set. We finish the function by outputting the total number of actively constrained degrees of freedom for which we sum over the number of actively constrained degrees of freedom owned by each of the processors. This number of locally owned constrained degrees of freedom is of course the number of elements of the intersection of the active set and the set of locally owned degrees of freedom, which we can get by using   <code>operator&</code>   on two IndexSets:
* 
...
* 
 @endcode
* 
*   <a name="PlasticityContactProblemcompute_nonlinear_residual"></a>  <h4>PlasticityContactProblem::compute_nonlinear_residual</h4>
* 
...
* 
 @endcode
* 
*   <a name="PlasticityContactProblemsolve_newton_system"></a>  <h4>PlasticityContactProblem::solve_newton_system</h4>
* 
...
* 
 ...
 @endcode
* 
*   <a name="PlasticityContactProblemsolve_newton"></a>  <h4>PlasticityContactProblem::solve_newton</h4>
* 
...
* 
 @endcode
* 
*   <a name="PlasticityContactProblemrefine_grid"></a>  <h4>PlasticityContactProblem::refine_grid</h4>
* 

* 
*  If you've made it this far into the deal.II tutorial, the following function refining the mesh should not pose any challenges to you any more. It refines the mesh, either globally or using the Kelly error estimator, and if so asked also transfers the solution from the previous to the next mesh. In the latter case, we also need to compute the active set and other quantities again, for which we need the information computed by   <code>compute_nonlinear_residual()</code>  .
* 
...
* 
 @endcode
* 
*   <a name="PlasticityContactProblemoutput_results"></a>  <h4>PlasticityContactProblem::output_results</h4>
* 
...
* 
 ...
 @endcode
* 
*   <a name="PlasticityContactProblemoutput_contact_force"></a>  <h4>PlasticityContactProblem::output_contact_force</h4>
* 
...
* 
*  There really isn't much to the   <code>main()</code>   function. It looks like they always do:
* 
...
* <a name="extensions"></a><a name="Possibilitiesforextensions"></a><h1>Possibilities for extensions</h1>
* 
...
der Umformtechnik metallischer Oberfl&auml;chen im Mikrokosmos</i>, Universityof Siegen, Germany, 2011.
*   <li>   It would also be an interesting advance to consider a contact problemwith friction. In almost every mechanical process friction has a biginfluence.  To model this situation, we have to take into account tangentialstresses at the contact surface. Friction also adds another inequality toour problem since body and obstacle will typically stick together as long asthe tangential stress does not exceed a certain limit, beyond which the twobodies slide past each other.
*   <li>   If we already simulate a frictional contact, the next step to consideris heat generation over the contact zone. The heat that iscaused by friction between two bodies raises the temperature in thedeformable body and entails an change of some material parameters.
