...
/**
 *
 * @defgroup mg Multilevel support 与多网格算法有关的类。
 ...
 * 这种分解的缺点是，我们需要额外的矩阵来处理细化边上出现的问题。此外，根据方法是连续的（因此在细化边缘有自由度）还是不连续的（在细化边缘采用通量矩阵），处理方法是不同的。虽然这些矩阵很小，但我们必须把它们集合起来，并通知多棱镜方法它们。
 *
 *
 */
